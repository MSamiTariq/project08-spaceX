				...
				> & {
						links?: Maybe<
							{ __typename?: "LaunchLinks" } & Pick<
								LaunchLinks,
								"article_link" | "wikipedia" | "video_link"
							>
						>;
					}
			>
...
export function useLaunchMissionInfoQuery(
	baseOptions: Apollo.QueryHookOptions<
		LaunchMissionInfoQuery,
		LaunchMissionInfoQueryVariables
	>
) {
	return Apollo.useQuery<
		LaunchMissionInfoQuery,
		LaunchMissionInfoQueryVariables
	>(LaunchMissionInfoDocument, baseOptions);
}
...
export type LaunchMissionInfoQueryHookResult = ReturnType<
	typeof useLaunchMissionInfoQuery
>;
export type LaunchMissionInfoLazyQueryHookResult = ReturnType<
	typeof useLaunchMissionInfoLazyQuery
>;
export type LaunchMissionInfoQueryResult = Apollo.QueryResult<
	LaunchMissionInfoQuery,
	LaunchMissionInfoQueryVariables
>;
